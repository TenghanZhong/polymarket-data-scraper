...
# ─── 配置 ───
EXCHANGE_ID, UNDERLYING = "deribit", "ETH"
SPOT_TICKER = "ETH/USDC"
LOOKAHEAD_DAYS = 183
...
def ETH_Option_Chain():
    ...
    for r in flat:
        ...
        greeks = r.get("greeks", {}) # 提前获取greeks字典
        ...
        (rows_syn if str(r.get("underlying_index", "")).startswith("SYN.") else rows_main).append(rec)
